...
#
#     bazel run @@//local_pkgs:crates_vendor
###############################################################################
"""
...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "axum": Label("//local_pkgs/crates/axum-0.4.8:axum"),
            "hyper": Label("//local_pkgs/crates/hyper-0.14.32:hyper"),
            "mime": Label("//local_pkgs/crates/mime-0.3.17:mime"),
            "serde_json": Label("//local_pkgs/crates/serde_json-1.0.150:serde_json"),
            "socket2": Label("//local_pkgs/crates/socket2-0.4.10:socket2"),
            "tokio": Label("//local_pkgs/crates/tokio-1.52.3:tokio"),
            "tower": Label("//local_pkgs/crates/tower-0.4.13:tower"),
            "tower-http": Label("//local_pkgs/crates/tower-http-0.2.5:tower_http"),
            "tracing": Label("//local_pkgs/crates/tracing-0.1.44:tracing"),
            "tracing-subscriber": Label("//local_pkgs/crates/tracing-subscriber-0.3.23:tracing_subscriber"),
        },
    },
}
